...
public class Test {
  public static void main(String[] args) throws IOException, DataFormatException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, IntrospectionException, NoSuchFieldException {
